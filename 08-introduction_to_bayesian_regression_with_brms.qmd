...
::: {.callout-note}
В работе [@ota2009] описывается эксперимент, в котором арабским и японским билингвам показывали английские слова и просили их определить, относятся ли они к одной семантической группе. В словах были в том числе и фонетически близкие слова, которые различаются фонемами, которых нет в L1.
:::
...
get_prior(Words.RT ~ Words.ACC + (1|Subject),
          data = df)
